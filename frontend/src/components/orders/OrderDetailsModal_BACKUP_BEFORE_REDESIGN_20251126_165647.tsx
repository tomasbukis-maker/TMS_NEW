            ...
            <div style={{ 
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '6px', fontSize: '12px' }}>
                ...
                {(localOrder.route_from_country || localOrder.route_from) && (
                  <div style={{ gridColumn: '1 / -1', fontSize: '11px', color: '#6c757d' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '8px' }}>
                      ...
                      {!localOrder.route_from_country && localOrder.route_from && (
                        <span>{localOrder.route_from}</span>
                      )}
                    </div>
                ...
                {(localOrder.loading_date || localOrder.unloading_date) && (
                  <div style={{ gridColumn: '1 / -1', fontSize: '11px', color: '#6c757d' }}>
                    {localOrder.loading_date && <span>Pakrovimas: {new Date(localOrder.loading_date).toLocaleDateString('lt-LT')}</span>}
                    {localOrder.loading_date && localOrder.unloading_date && <span> • </span>}
                    {localOrder.unloading_date && <span>Iškrovimas: {new Date(localOrder.unloading_date).toLocaleDateString('lt-LT')}</span>}
                  </div>
                )}
